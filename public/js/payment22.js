...
const stripe = Stripe("pk_test_51IRXvsKfDxNUQugfkisukKjRolKlxiia4L8VrRvuINwwh75TVxrL70ooCVx63cj8HxSnDUuJtHxPdXTBcmLQAYvS00FBOjfPr0");
...
window.document.querySelector('#form_payment').addEventListener('submit', function(e) {
    ...
    /* errorが返ってきた場合はその旨を表示 */
            if (result.error) {
                ...
                alert("カード登録処理時にエラーが発生しました。カード番号が正しいものかどうかをご確認いただくか、別のクレジットカードで登録してみてください。",result.error);
            } else {
